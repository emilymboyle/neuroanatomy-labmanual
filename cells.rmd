...
```{r neuronlabel, fig.cap='(ref:neuronlab)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/cells/Complete_neuron_cell_diagram_for_labelling.svg")
```
...
```{r neurontypelabel, fig.cap='(ref:neurontypelab)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/cells/CajalNeurons_for_labeling.png")
```
...
```{r glialabel, fig.cap='(ref:glialab)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/cells/CajalGlia_for_labeling.png")
```
