...
<img src="./figures/cells/Complete_neuron_cell_diagram_for_labelling.svg" alt="(ref:neuronlab)" width="70%" />
<p class="caption">(\#fig:neuronlabel)(ref:neuronlab)</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="./figures/cells/CajalNeurons_for_labeling.png" alt="(ref:neurontypelab)" width="70%" />
<p class="caption">(\#fig:neurontypelabel)(ref:neurontypelab)</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="./figures/cells/CajalGlia_for_labeling.png" alt="(ref:glialab)" width="70%" />
<p class="caption">(\#fig:glialabel)(ref:glialab)</p>
</div>
