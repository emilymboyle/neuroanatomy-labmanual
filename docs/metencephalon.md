...
In this laboratory session, we will study the anatomy of the human metencephalon. Below, you will be presented with a number of figures and asked to label or color certain structures in each figure.
